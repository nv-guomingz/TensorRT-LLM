...
![Figure 1: Kernel breakdown when scaling EP without EPLB](../media/tech_blog8_kernel_breakdown.png)
...
![Figure 2: Sparsity of valid expanded tokens. For DeepSeek-R1 deployed with EP 32, a batch of 12 tokens are expanded to 96 tokens, but only 3 are valid on rank 0.](../media/tech_blog8_moe_aux_kernels1.png)
...
![Figure 3: Optimization effect on MoE auxiliary kernels. (Left) Before optimization, kernel time increases with EP size. (Right) After optimization, kernel time remains constant with EP size.](../media/tech_blog8_moe_aux_kernels2.png)
...
![Figure 4: Optimization effect on communication kernels.](../media/tech_blog8_communication_kernel.png)
...
![Figure 5: DeepSeek R1 throughput on ISL/OSL 1k/1k.](../media/tech_blog8_perf-1k-1k-dep.png)

![Figure 6: DeepSeek R1 throughput on ISL/OSL 4k/1k.](../media/tech_blog8_perf-4k-1k-dep.png)

![Figure 7: DeepSeek R1 throughput on ISL/OSL 8k/1k.](../media/tech_blog8_perf-8k-1k-dep.png)
...
![Figure 8: DeepSeek R1 throughput on ISL/OSL 8k/1k with MTP enabled.](../media/tech_blog8_perf-8k-1k-e2e-mtp.png)
