...
def generate_examples():
    ...
    llmapi_script_base_url = f"https://github.com/NVIDIA/TensorRT-LLM/tree/{commit_hash}/examples/llm-api"
    ...
    serve_script_base_url = f"https://github.com/NVIDIA/TensorRT-LLM/tree/{commit_hash}/examples/serve"
