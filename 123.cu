...
void invokefusedAGemm(T* output, T const* mat_a, T const* mat_b, cudaStream_t const stream)
{
    ...
    int const gemm_n = kNumTokens; // 16
    constexpr int gemm_k = kHdIn;  // 7168
    constexpr int batch_size = 1;
    std::swap(mat_a, mat_b);
    constexpr int tile_m = 16;
    constexpr int tile_n = gemm_n > 8 ? 16 : 8;                    // 8 or 16
    ...
    int cta_n_cnt = (gemm_n + tile_n - 1) / tile_n;                // 4
...
template void invokefusedAGemm<__nv_bfloat16, 1, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 2, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 3, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 4, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 5, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 6, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 7, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 8, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 9, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 10, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 11, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 12, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 13, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 14, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 15, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);

template void invokefusedAGemm<__nv_bfloat16, 16, 7168, 2112>(
    __nv_bfloat16*, __nv_bfloat16 const*, __nv_bfloat16 const*, cudaStream_t);
