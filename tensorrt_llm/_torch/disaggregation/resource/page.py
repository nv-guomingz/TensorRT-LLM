...
class MambaLayerGroup(LayerGroup):
    ...
    conv_layer_base_addresses: Optional[Dict[int, int]] = None
    ssm_layer_base_addresses: Optional[Dict[int, int]] = None
    conv_slot_stride_bytes: Optional[int] = None
    ssm_slot_stride_bytes: Optional[int] = None
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "conv_layer_base_addresses": {
                int(k): int(v) for k, v in (self.conv_layer_base_addresses or {}).items()
            }
            if self.conv_layer_base_addresses is not None
            else None,
            "ssm_layer_base_addresses": {
                int(k): int(v) for k, v in (self.ssm_layer_base_addresses or {}).items()
            }
            if self.ssm_layer_base_addresses is not None
            else None,
            "conv_slot_stride_bytes": self.conv_slot_stride_bytes,
            "ssm_slot_stride_bytes": self.ssm_slot_stride_bytes,
        }
    ...
    def from_dict(cls, data: dict) -> "MambaLayerGroup":
        ...
        conv_layer_base_addresses = data.get("conv_layer_base_addresses")
        ssm_layer_base_addresses = data.get("ssm_layer_base_addresses")
        return cls(
            pool_group_idx=int(data["pool_group_idx"]),
            ...
            conv_layer_base_addresses={int(k): int(v) for k, v in conv_layer_base_addresses.items()}
            if conv_layer_base_addresses is not None
            else None,
            ssm_layer_base_addresses={int(k): int(v) for k, v in ssm_layer_base_addresses.items()}
            if ssm_layer_base_addresses is not None
            else None,
            conv_slot_stride_bytes=data.get("conv_slot_stride_bytes"),
            ssm_slot_stride_bytes=data.get("ssm_slot_stride_bytes"),
        )
