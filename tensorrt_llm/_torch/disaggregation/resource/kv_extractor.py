...
def _build_layer_group_for_v2_mamba(
    ...
    return MambaLayerGroup(
        ...
        conv_section_bytes=conv_section_bytes,
        ssm_bytes_per_head=ssm_bytes_per_head,
        conv_layer_base_addresses=conv_layer_base_addresses,
        ssm_layer_base_addresses=ssm_layer_base_addresses,
        conv_slot_stride_bytes=conv_slot_stride_bytes,
        ssm_slot_stride_bytes=ssm_slot_stride_bytes,
    )
