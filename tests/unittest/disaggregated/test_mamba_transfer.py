...
def test_mamba_policy_slot_major_layer_ptrs():
    ...
    self_mlg = page.MambaLayerGroup(
        ...
        conv_layer_base_addresses={1: 1000, 2: 2000},
        ssm_layer_base_addresses={1: 3000, 2: 4000},
        conv_slot_stride_bytes=64,
        ssm_slot_stride_bytes=128,
    )
    peer_mlg = page.MambaLayerGroup(
        ...
        conv_section_bytes=[10],
        ssm_bytes_per_head=10,
        conv_layer_base_addresses={1: 5000, 2: 6000},
        ssm_layer_base_addresses={1: 7000, 2: 8000},
        conv_slot_stride_bytes=64,
        ssm_slot_stride_bytes=128,
    )
